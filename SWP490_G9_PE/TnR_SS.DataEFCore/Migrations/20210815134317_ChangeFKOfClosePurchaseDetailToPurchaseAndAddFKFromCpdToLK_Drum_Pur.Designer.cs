...
namespace TnR_SS.DataEFCore.Migrations
{
    ...
    [Migration("20210815134317_ChangeFKOfClosePurchaseDetailToPurchaseAndAddFKFromCpdToLK_Drum_Pur")]
    partial class ChangeFKOfClosePurchaseDetailToPurchaseAndAddFKFromCpdToLK_Drum_Pur
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.ClosePurchaseDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("BasketWeight")
                        .HasColumnType("float");
                    ...
                    b.Property<float>("FishTypeMaxWeight")
                        .HasColumnType("real");

                    b.Property<float>("FishTypeMinWeight")
                        .HasColumnType("real");

                    b.Property<double>("FishTypePrice")
                        .HasColumnType("float");

                    b.Property<double>("FishTypeTransactionPrice")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ClosePurchaseDetails");
                });
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.LK_PurchaseDeatil_Drum", b =>
                {
                    ...
                    b.Property<int?>("ClosePurchaseDetailID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClosePurchaseDetailID");
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.RoleUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "2712ba23-49c8-40f9-9852-3973c304352d",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Chủ bến",
                            Name = "WeightRecorder",
                            NormalizedName = "WEIGHTRECORDER",
                            UpdatedAt = new DateTime(2021, 8, 15, 20, 43, 16, 895, DateTimeKind.Local).AddTicks(9861)
                        },
                        new
                        {
                            Id = 1,
                            ConcurrencyStamp = "9ae2345c-ce21-430e-a9e3-d521782de89e",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Thương lái",
                            Name = "Trader",
                            NormalizedName = "TRADER",
                            UpdatedAt = new DateTime(2021, 8, 15, 20, 43, 16, 898, DateTimeKind.Local).AddTicks(150)
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "4679db98-1363-4ace-b31f-b746b8755b0f",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Admin",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2021, 8, 15, 20, 43, 16, 898, DateTimeKind.Local).AddTicks(212)
                        });
                });
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.LK_PurchaseDeatil_Drum", b =>
                {
                    b.HasOne("TnR_SS.Domain.Entities.ClosePurchaseDetail", "ClosePurchaseDetail")
                        .WithMany("LK_PurchaseDeatil_Drums")
                        .HasForeignKey("ClosePurchaseDetailID")
                    ...
                    b.Navigation("ClosePurchaseDetail");
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.Purchase", b =>
                {
                    b.Navigation("ClosePurchaseDetails");
