...
namespace TnR_SS.DataEFCore.Migrations
{
    ...
    [Migration("20210713172615_addTableHistorySalaryEmp")]
    partial class addTableHistorySalaryEmp
    {
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.RoleUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "22c19dbf-2dd9-4ef3-a001-753338fa6243",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Chủ bến",
                            Name = "WeightRecorder",
                            NormalizedName = "WEIGHTRECORDER",
                            UpdatedAt = new DateTime(2021, 7, 14, 0, 26, 15, 280, DateTimeKind.Local).AddTicks(5113)
                        },
                        new
                        {
                            Id = 1,
                            ConcurrencyStamp = "6d6dc15f-bdc6-47ea-b36d-3ea6bd252597",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Thương lái",
                            Name = "Trader",
                            NormalizedName = "TRADER",
                            UpdatedAt = new DateTime(2021, 7, 14, 0, 26, 15, 281, DateTimeKind.Local).AddTicks(6041)
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "c7de3235-8353-4303-8d0c-c0fa760991d6",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Admin",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2021, 7, 14, 0, 26, 15, 281, DateTimeKind.Local).AddTicks(6074)
                        });
                });
