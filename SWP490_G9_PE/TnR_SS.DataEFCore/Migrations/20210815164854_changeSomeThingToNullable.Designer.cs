...
namespace TnR_SS.DataEFCore.Migrations
{
    ...
    [Migration("20210815164854_changeSomeThingToNullable")]
    partial class changeSomeThingToNullable
    {
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.RoleUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "894395e2-0233-4558-9ce5-f3ee6a3ed1c0",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Chủ bến",
                            Name = "WeightRecorder",
                            NormalizedName = "WEIGHTRECORDER",
                            UpdatedAt = new DateTime(2021, 8, 15, 23, 48, 53, 981, DateTimeKind.Local).AddTicks(9235)
                        },
                        new
                        {
                            Id = 1,
                            ConcurrencyStamp = "801c3b00-8dc2-4324-b38a-33a5ed429011",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Thương lái",
                            Name = "Trader",
                            NormalizedName = "TRADER",
                            UpdatedAt = new DateTime(2021, 8, 15, 23, 48, 53, 984, DateTimeKind.Local).AddTicks(1537)
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "b833ba9a-dca5-478d-8c30-cbbfa8754a10",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Admin",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2021, 8, 15, 23, 48, 53, 984, DateTimeKind.Local).AddTicks(1602)
                        });
                });
