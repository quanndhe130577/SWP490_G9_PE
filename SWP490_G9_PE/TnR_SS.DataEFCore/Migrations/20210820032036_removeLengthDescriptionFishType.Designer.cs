...
namespace TnR_SS.DataEFCore.Migrations
{
    ...
    [Migration("20210820032036_removeLengthDescriptionFishType")]
    partial class removeLengthDescriptionFishType
    {
            ...
            modelBuilder.Entity("TnR_SS.Domain.Entities.RoleUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "312426fd-d101-4628-a626-ec175c6cfb6d",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Chủ bến",
                            Name = "WeightRecorder",
                            NormalizedName = "WEIGHTRECORDER",
                            UpdatedAt = new DateTime(2021, 8, 20, 10, 20, 35, 18, DateTimeKind.Local).AddTicks(376)
                        },
                        new
                        {
                            Id = 1,
                            ConcurrencyStamp = "4cee5633-c0b3-43a2-8377-940ceee76ba2",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Thương lái",
                            Name = "Trader",
                            NormalizedName = "TRADER",
                            UpdatedAt = new DateTime(2021, 8, 20, 10, 20, 35, 20, DateTimeKind.Local).AddTicks(4630)
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "74813782-7d03-4fc7-a926-78e5734d0ee7",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DisplayName = "Admin",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2021, 8, 20, 10, 20, 35, 20, DateTimeKind.Local).AddTicks(4705)
                        });
                });
