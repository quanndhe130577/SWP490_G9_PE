    ...
    public partial class createInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "6d48bf32-a305-42a5-8b43-3bb891efa164", "Admin", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "DisplayName", "Name", "NormalizedName" },
                values: new object[] { 2, "19f7f92f-14bc-4b8b-9105-1e3639d61d8f", "Thương lái", "Trader", "TRADER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "DisplayName", "Name", "NormalizedName" },
                values: new object[] { 3, "d7d218d6-3490-4b1e-96d0-3bbcb14cd90e", "Chủ bến", "Weight Recorder", "WEIGHT RECORDER" });
